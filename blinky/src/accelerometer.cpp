...
#include "Particle.h"
#line 1 "/Users/arminmahmoudi/dev/lights/particle/blinky/src/accelerometer.ino"
#include <math.h>

void setXYZ(float xyz[]);
int ReadAxis(int axisPin, int sampleSize);
void AutoCalibrate();
#line 3 "/Users/arminmahmoudi/dev/lights/particle/blinky/src/accelerometer.ino"
const int xInput = A3;
const int yInput = A4;
const int zInput = A5;
